...
export const ADD_BASIC_GOOD = 'ADD_BASIC_GOOD'
export const GET_BASIC_GOODS = 'GET_BASIC_GOODS'
export const EDIT_BASIC_GOOD = 'EDIT_BASIC_GOOD'
export const SAVE_BASIC_GOOD = 'SAVE_BASIC_GOOD'
export const DELETE_BASIC_GOOD = 'DELETE_BASIC_GOOD'
